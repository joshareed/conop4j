...
public class AdaptiveCooling implements CoolingSchedule {
	 ...
	 */
	public AdaptiveCooling(final double initial, final double factor, final long minStepsPer) {
	 ...
	 *            due to no progress.
	 */
	public AdaptiveCooling(final double initial, final double factor, final long minStepsPer, final long noProgress) {
